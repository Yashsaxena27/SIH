  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        {/* City / Deployment */}
        <div className="flex items-center gap-2 px-2.5 py-1 rounded-lg bg-white/[0.02] border border-white/[0.05] cursor-pointer hover:bg-white/[0.04] transition-colors group">
          <MapPin className="w-3 h-3 text-accent-secondary/70 flex-shrink-0" />
          <div className="hidden sm:block">
            <div className="text-[11px] font-semibold text-white/80 leading-none">Delhi NCR</div>
            <div className="text-[9px] text-white/30 leading-none mt-[2px]">Pilot Deployment</div>
          </div>
          <ChevronDown className="w-2.5 h-2.5 text-white/20 group-hover:text-white/40 transition-colors hidden sm:block" />
        </div>
