...
const navItems: NavItem[] = [
  ...
  { label: 'Inspections',      path: '/verification', icon: ClipboardCheck },
  { label: 'Analytics',        path: '/analytics',    icon: BarChart3 },
  { label: 'Priority Actions', path: '/tickets',      icon: AlertCircle, badge: 5 },
  { label: 'Reports',          path: '/reports',      icon: FileText },
  { label: 'Notifications',    path: '/alerts',       icon: Bell, badge: 3 },
