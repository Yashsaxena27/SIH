            ...
            <DropdownMenu.Root key={section.id}>
              ...
              <DropdownMenu.Portal>
                <DropdownMenu.Content 
                  ...
                  align="center"
                  sideOffset={12}
                  className="z-50 min-w-[200px] p-2 rounded-2xl bg-[#131314]/95 backdrop-blur-3xl border border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.8)] animate-in fade-in zoom-in-95 duration-200"
                >
                  ...
                  <DropdownMenu.Arrow className="fill-white/5" />
                </DropdownMenu.Content>
              </DropdownMenu.Portal>
            </DropdownMenu.Root>
          );
