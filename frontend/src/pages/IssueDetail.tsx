            ...
            <div className="aspect-video w-full relative bg-[#1a1a24] overflow-hidden">
              ...
              <div className="absolute top-4 left-4 right-4 flex justify-between items-start pointer-events-none">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-white/70 text-[10px] font-mono bg-black/40 px-2 py-1 rounded backdrop-blur-md border border-white/[0.05]">CAM_FR_01</span>
                </div>
                <div className="flex flex-col items-end gap-1 text-right">
                  <span className="text-white/90 text-[10px] font-mono bg-black/40 px-2 py-1 rounded backdrop-blur-md border border-white/[0.05]">{formatDate(issue.lastObservedAt, 'long')}</span>
                  <span className="text-white/60 text-[10px] font-mono bg-black/40 px-2 py-1 rounded backdrop-blur-md border border-white/[0.05]">GPS: {issue.location.coordinates[1].toFixed(6)}, {issue.location.coordinates[0].toFixed(6)}</span>
                </div>
              </div>
            </div>
          </GlassPanel>
