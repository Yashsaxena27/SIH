        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-32 h-24">
            ...
            <div className="absolute -inset-4 border-2 border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.3)]">
              <div className="absolute -top-6 left-[-2px] bg-red-500 text-white text-[10px] font-mono font-bold px-1.5 py-0.5 uppercase">
                DEFECT_DETECTED
              </div>
            </div>
          </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-36 h-28">
            ...
            <div className="absolute -inset-2 border-2 border-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.3)]">
              <div className="absolute -top-6 left-[-2px] bg-emerald-500 text-white text-[10px] font-mono font-bold px-1.5 py-0.5 uppercase">
                SURFACE_REPAIRED
              </div>
            </div>
          </div>
            ...
            <GlassPanel className="xl:col-span-2 overflow-hidden flex flex-col p-0 border-white/[0.1]">
              ...
              >
                ...
                <div className="absolute inset-0">
                  ...
                  <div className="absolute bottom-4 left-4 bg-white/60 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/[0.1] z-10">
                ...
                >
                  ...
                  {activeCase.status !== 'pending' && (
                    <div className="absolute bottom-4 right-4 bg-white/60 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/[0.1] text-right z-10">
