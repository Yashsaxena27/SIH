    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-w-[1920px] mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
        {[
          ...
          >
            <GlassPanel hover padding="sm" className="relative overflow-hidden group h-[88px] flex flex-col justify-between cursor-pointer">
              {/* Colored Glow Orb */}
              <div 
              ...
              <div className="flex items-end justify-between z-10 mt-2">
                <div className="text-4xl font-bold font-mono tracking-tight text-white/90 group-hover:text-white transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
        ...
        >
          ...
          <div className="absolute top-4 left-4 z-20 px-3 py-1.5 rounded-lg bg-white/40 backdrop-blur-md border border-white/[0.1] flex items-center gap-2">
        ...
        <div className="lg:col-span-4 xl:col-span-3 space-y-4 sm:space-y-6 flex flex-col h-full">
          ...
          >
            <GlassPanel padding="md" className="h-full flex flex-col relative overflow-hidden">
              ...
              <div className="absolute top-0 left-0 right-0 h-10 bg-gradient-to-b from-white to-transparent z-10 pointer-events-none rounded-t-xl" />
              <div className="absolute bottom-0 left-0 right-0 h-10 bg-gradient-to-t from-white to-transparent z-10 pointer-events-none rounded-b-xl" />
