  ...
  return (
    <div className={cn("flex flex-col space-y-4 sm:space-y-6", viewMode === 'map' ? "h-[calc(100vh-3.5rem)] p-0" : "p-4 sm:p-6")}>
      ...
      <div className={cn("flex flex-col lg:flex-row lg:items-end justify-between gap-4", viewMode === 'map' && "absolute top-4 left-4 right-4 z-10")}>
        ...
        <div className={cn(viewMode === 'map' && "bg-white/40 backdrop-blur-md p-4 rounded-xl border border-white/[0.1] w-max")}>
        ...
        <div className={cn("flex flex-col sm:flex-row items-center gap-3", viewMode === 'map' && "bg-white/40 backdrop-blur-md p-2 rounded-xl border border-white/[0.1]")}>
