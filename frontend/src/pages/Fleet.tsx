        ...
        <div className="xl:col-span-5 flex flex-col gap-6">
          ...
          <GlassPanel padding="none" className="flex-1 min-h-[300px] flex flex-col overflow-hidden relative">
            <div className="absolute top-4 left-4 right-4 z-10 flex items-center justify-between pointer-events-none">
              <div className="bg-white/60 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/[0.1] pointer-events-auto">
              ...
              <div className="flex flex-col gap-1 items-end pointer-events-auto">
                <div className="bg-white/60 backdrop-blur-md px-2 py-1 rounded border border-white/[0.1] text-[10px] font-bold uppercase tracking-widest text-purple-400 flex items-center gap-1.5">
                  <div className="w-3 h-0.5 bg-purple-500" /> Observed
                </div>
                <div className="bg-white/60 backdrop-blur-md px-2 py-1 rounded border border-white/[0.1] text-[10px] font-bold uppercase tracking-widest text-white/40 flex items-center gap-1.5">
        ...
        {selectedBus && (
          <>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 z-[400] bg-white/40 backdrop-blur-sm"
                    ...
                    {[
                      ...
                      <div key={evt.id} className="p-3 rounded-lg border border-white/[0.04] bg-white/[0.01] flex items-center justify-between group hover:bg-white/[0.03] transition-colors">
                        <div className="flex items-center gap-3">
                          <div className="text-xs font-mono text-white/40 bg-white/40 px-1.5 py-0.5 rounded">{evt.time}</div>
